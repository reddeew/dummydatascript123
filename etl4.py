...
def generate_realistic_name():
    first_names = ['John', 'Jane', 'Michael', 'Emily', 'David', 'Sarah', 'Daniel', 'Jessica', 'James', 'Elizabeth',
                   'William', 'Olivia', 'Benjamin', 'Ava', 'Jacob', 'Sophia', 'Ethan', 'Isabella', 'Alexander', 'Mia',
                   'Liam', 'Charlotte', 'Noah', 'Amelia', 'Elijah', 'Harper', 'Lucas', 'Evelyn', 'Mason', 'Abigail',
                   'Logan', 'Ella', 'Ethan', 'Avery', 'Jackson', 'Mila', 'Sebastian', 'Scarlett', 'Carter', 'Luna',
                   'Henry', 'Grace', 'Owen', 'Chloe', 'Gabriel', 'Penelope', 'Matthew', 'Lily', 'Wyatt', 'Sophie']
    last_names = ['Smith', 'Johnson', 'Williams', 'Brown', 'Jones', 'Miller', 'Davis', 'Garcia', 'Rodriguez', 'Martinez',
                  ...
                  'Scott', 'Green', 'Adams', 'Baker', 'Evans', 'Cook', 'Murphy', 'Rivera', 'Cooper', 'Reed',
...
def generate_transactions_data(file_name):
    with open(file_name, 'w', newline='') as csvfile:
        ...
        for _ in range(file_size_mb * 1024):
            transaction_id = random.randint(100000, 200000)  # Adjusted to ensure some transaction IDs match employee IDs
...
def generate_accounts_data(file_name):
    with open(file_name, 'w', newline='') as csvfile:
        ...
        for _ in range(file_size_mb * 1024):
            account_id = random.randint(10000, 99999)  # Adjusted to ensure more unique values
